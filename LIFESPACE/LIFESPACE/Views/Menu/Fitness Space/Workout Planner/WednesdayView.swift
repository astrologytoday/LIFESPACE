...
struct WednesdayView: View {
    ...
    @AppStorage("WednesdayWorkout") var wednesdayWorkout: String = "Back / Biceps"
    @AppStorage("WednesdayWorkoutList") private var savedWorkoutData: String = ""
            ...
            ScrollViewReader { proxy in
                ScrollView(showsIndicators: false) {
                    VStack(spacing: 24) {
                        ...
                        // 🧠 Title
                        Text("WEDNESDAY – \(wednesdayWorkout.uppercased())")
