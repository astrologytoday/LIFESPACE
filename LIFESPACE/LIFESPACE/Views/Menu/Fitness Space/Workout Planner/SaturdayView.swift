...
struct SaturdayView: View {
    ...
    @AppStorage("SaturdayWorkout") var saturdayWorkout: String = "Full Body"
    @AppStorage("SaturdayWorkoutList") private var savedWorkoutData: String = ""
            ...
            ScrollViewReader { proxy in
                ScrollView(showsIndicators: false) {
                    VStack(spacing: 24) {
                        ...
                        // 🧠 Title
                        Text("SATURDAY – \(saturdayWorkout.uppercased())")
