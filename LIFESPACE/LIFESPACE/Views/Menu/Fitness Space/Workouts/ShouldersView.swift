        ...
        ZStack {
            ...
            VStack(spacing: 30) {
                ...
                VStack(spacing: 20) {
                    ...
                    workoutButton("Lateral Shoulder Raise") {
                        fadeAndNavigate(to: "LateralShoulderRaiseView")
                    }
                    workoutButton("Arnold Press") {
                        fadeAndNavigate(to: "ArnoldPressView")
                    }
                    workoutButton("Empty the Can") {
                        fadeAndNavigate(to: "EmptyTheCanView")
                    }
                    workoutButton("Shoulder Cross Raise") {
                        fadeAndNavigate(to: "ShoulderCrossRaiseView")
                    }
