...
struct FridayView: View {
    ...
    @AppStorage("FridayWorkout") var fridayWorkout: String = "Rest"
    @AppStorage("FridayWorkoutList") private var savedWorkoutData: String = ""
    ...
    var body: some View {
            ...
            ScrollViewReader { proxy in
                ScrollView(showsIndicators: false) {
                    VStack(spacing: 24) {
                        ...
                        // 🧠 Title
                        Text("FRIDAY – \(fridayWorkout.uppercased())")
        ...
        // ✅ Keeps buttons at true bottom (keyboard will cover them while typing)
