...
struct PSSDBuildingBlocksMatrixView: View {
...
// MARK: - Dedicated cell type so it doesn't clash with others
private struct PSSDMatrixCell: View {
    let title: String
    let selected: Bool
    let size: CGSize
    let corner: CGFloat
