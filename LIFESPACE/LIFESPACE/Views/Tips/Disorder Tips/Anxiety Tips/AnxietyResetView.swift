                ...
                VStack(spacing: 44) {
                    ...
                    Button(action: {
                        withAnimation(.easeInOut(duration: 0.4)) {
                            currentReset = AnxietyResetData.randomElement() ?? currentReset
                        }
                    }) {
                    ...
                    VStack(spacing: 18) {
                        ...
                        Text("""
Use one of the prompts to help stabilize yourself during a panic attack or anxiety episode. Once feeling more grounded, start making a plan for the rest of your day.
""")
        ...
        .onAppear {
            currentReset = AnxietyResetData.randomElement() ?? "Take a deep breath"
        }
    }
    ...
    private let AnxietyResetData: [String] = [
        "Take a hot shower",
        "Go for a walk",
        ...
        "Keep breathing in 4 seconds, holding for 4 seconds, and then exhaling for 4 seconds, until the panic stops",
        "Keep breathing in 4 seconds, holding for 7 seconds, and then exhaling for 8 seconds, until the panic stops",
