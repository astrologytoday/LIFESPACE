...
struct SundayView: View {
    ...
    @AppStorage("SundayWorkout") var sundayWorkout: String = "Legs / Abs"
    @AppStorage("SundayWorkoutList") private var savedWorkoutData: String = ""
            ...
            ScrollViewReader { proxy in
                ScrollView(showsIndicators: false) {
                    VStack(spacing: 24) {
                        ...
                        // 🧠 Title
                        Text("SUNDAY – \(sundayWorkout.uppercased())")
