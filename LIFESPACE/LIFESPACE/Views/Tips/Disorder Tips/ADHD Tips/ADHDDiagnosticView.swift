...
struct ADHDDiagnosticView: View {
    @EnvironmentObject var navModel: NavigationModel

    // --- Symptom Checklist Items (UNCHANGED COPY) ---
    let symptoms = [
        "I have started many projects but have not finished any",
        "I am always disorganized",
        "I have trouble getting materials together for a specific task",
        "I often miss appointments and forget my obligations",
        "I am always procrastinating",
        "I cannot sit still",
        "I feel impulsive and often do things without thinking",
        "I get distracted easily and can't concentrate for a long time",
        "I have trouble knowing when it's my turn to speak and am overly talkative",
        "My mind is restless and I experience racing thoughts",
        "I often forget where I placed things",
        "I often walk into a room and forget why I walked in"
    ]
    ...
    @AppStorage("ADHDDiagnostic_symptomChecks") private var symptomChecksData: Data = Data(count: 12)
    ...
    @AppStorage("ADHDDiagnostic_lastResultRisk") private var lastResultRisk: String = ""
    @AppStorage("diagnosticNotifications") private var diagnosticNotificationsEnabled: Bool = true

    // --- UI State ---
    @State private var symptomChecks: [Bool] = Array(repeating: false, count: 12)
    ...
    func submitAssessment() {
        ...
        if symptomCount >= 5 && diagnosticNotificationsEnabled {
            NotificationManager.shared.scheduleSixMonthRetestNotification(for: "ADHD")
        }

        navModel.selectedScreen = "ADHDResultView"
    }
        ...
        ZStack {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 24) {
                    ...
                    // Title
                    Text("LIFESPACE ADHD Risk Assessment")
                    ...
                    // Disclaimer
                    Text("""
                    This is a self-reflection tool, not a medical diagnosis. If symptoms are severe, persistent, or interfering with daily life, please consult a qualified healthcare or mental health professional.
                    """)
