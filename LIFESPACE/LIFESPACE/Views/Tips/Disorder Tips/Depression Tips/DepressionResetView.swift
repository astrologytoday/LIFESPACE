...
struct DepressionResetView: View {
            ...
            ScrollView {   // ← WRAP ENTIRE VIEW TO ALLOW VERTICAL EXPANSION SAFELY
                VStack(spacing: 44) {
                    ...
                    VStack(spacing: 18) {
                        ...
                        Text("""
Use one of the prompts to shake yourself out of a depressive episode. Once feeling more stabilized, start making a plan for the rest of your day.
""")
