...
struct WritingCreativeView: View {
        ...
        ZStack {
            ...
            VStack(spacing: 16) {
                ...
                VStack(alignment: .leading, spacing: 14) {
                    ...
                    VStack(alignment: .leading, spacing: 14) {
                        tipRow("Write a scene where two people want the same thing for different reasons.")
                        tipRow("Start with a lie your narrator believes, then break it.")
                        tipRow("Describe a room using only senses other than sight.")
                        tipRow("Write a dialogue where nobody answers the question directly.")
                        tipRow("Take a real memory and change one detail. See what it becomes.")
                    }
                }
                .padding(18)
                .background(
                ...
                // ✅ Main button
                VStack(spacing: 14) {
                    bigActionButton(systemName: "pencil.and.scribble", title: "Start Creative Writing") {
                        fadeOutThen { navModel.push("CreativeWritingView") }
                    }
                }
