...
struct ThursdayView: View {
    ...
    @AppStorage("ThursdayWorkout") var thursdayWorkout: String = "Shoulders / Traps"
    @AppStorage("ThursdayWorkoutList") private var savedWorkoutData: String = ""
            ...
            ScrollViewReader { proxy in
                ScrollView(showsIndicators: false) {
                    VStack(spacing: 24) {
                        ...
                        // 🧠 Title
                        Text("THURSDAY – \(thursdayWorkout.uppercased())")
