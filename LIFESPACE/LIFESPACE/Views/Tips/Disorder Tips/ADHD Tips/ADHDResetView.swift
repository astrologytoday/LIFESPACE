                ...
                VStack(spacing: 44) {
                    ...
                    Button(action: {
                        withAnimation(.easeInOut(duration: 0.4)) {
                            currentReset = ADHDResetData.randomElement() ?? currentReset
                        }
                    }) {
                    ...
                    VStack(spacing: 18) {
                        ...
                        Text("""
If you are feeling easily distracted, use one of the grounding techniques to reset your mind and ground yourself. Once feeling more grounded, start making a plan for the rest of your day and then follow through!
""")
        ...
        .onAppear {
            currentReset = ADHDResetData.randomElement() ?? "Take a deep breath"
        }
    }
    ...
    func resetCard(for reset: String) -> some View {
        ...
        case "Play an instrument for 20 minutes":
            highlightedCard(
                before: "Play an instrument for ",
                link: "20 minutes",
                after: "",
                action: { navModel.push("TimerView") }
            )
    ...
    private let ADHDResetData: [String] = [
        "Take a hot shower",
        "Go for a walk",
        ...
        "Take a nap",
        "Light some incense",
        "Play an instrument for 20 minutes",
